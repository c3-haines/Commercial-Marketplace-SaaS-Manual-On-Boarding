...
**Please note the sample uses the preview version of .NET SDK for Commercial Marketplace source (Microsoft.Marketplace project in the solution) and refers to it as a tree. Please see [git reference for using read-tree](https://git-scm.com/docs/git-read-tree).**
